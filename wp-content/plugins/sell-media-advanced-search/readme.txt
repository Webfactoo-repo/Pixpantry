...
Adds additional searching features such as; Keywords (using autocomplete), minimum and maximum price, Collection or License Type, aspect ratio (portrait or landscape) for the Sell Media Plugin.
...
= 1.0.5 =
* Tweak: Updating ajaxurl
* Fix: Only images are included in portrait/landscape search
* Fix: No search result loads the search template/no results found
* Removing html5 number support
* Adding currency symbol next to price range

= 1.0.4 =
* Updated readme.txt
* Added additional actions for developers

= 1.0.3 =
* Styling improvements
* Better support for portrait and landscape images when displayed in results
* Improved multi-language searching support
* Improved code
