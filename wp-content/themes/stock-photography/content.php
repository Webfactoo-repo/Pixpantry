...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		...
		if ( '' != get_the_post_thumbnail() && ! is_single() ) { ?>
			<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'stock_photography' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark" class="archive-thumbnail">
	...
	<div class="entry-content">
		<?php if ( is_single() ) {
			the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'stock_photography' ) );
		} else {
			the_excerpt();
		} ?>
